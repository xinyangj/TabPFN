#!/usr/bin/env python
"""Generate interpretation training data matched to DREAM4-10 distribution.

Based on v5 pipeline but with:
  - n_features: uniform [5, 15] (DREAM4-10 has 9)
  - n_samples: uniform [50, 300] (DREAM4-10 has ~136)
  - Same 3-stage async pipeline as v5

Usage:
    python scripts/generate_interpretation_data_dream.py --n_datasets 2000 --device cuda:1
"""
...
CACHE_DIR = Path("data/interpretation_cache_dream")
...
def _sample_n_samples(rng: np.random.Generator) -> int:
    return int(rng.integers(50, MAX_TRAIN_SAMPLES + 1))  # [50, 300]
...
def generate_and_cache(
    ...
    *,
    ...
    manifest = {
        ...
        "feature_distribution": "uniform [5, 15] (DREAM4-10 matched)",
        "max_train_samples": MAX_TRAIN_SAMPLES,
        "target_benchmark": "DREAM4-10 (9 features, ~136 samples)",
